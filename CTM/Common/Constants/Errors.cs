namespace CTM.Common.Constants
{
    ...
    {
        const string Postcode = @"Your postcode has not been recognised, " + 
            "please check you have entered it correctly and if you still need help " + 
            "call the switching support team on 0800 093 6831";

        const string Complete = "Complete this section to continue {} " + 
            "remaining view question";

        const string Email = "Your email doesn’t appear to be valid. " + 
            "please check you have entered it correctly.";

        const string ReviewElectricitySpend = "We've calculated that your electricity usage is negative.\n" + 
